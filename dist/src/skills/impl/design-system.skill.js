...
var DesignSystemSkill_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.DesignSystemSkill = void 0;
...
let DesignSystemSkill = DesignSystemSkill_1 = class DesignSystemSkill {
    aiGateway;
    validator;
    name = 'DesignSystem';
    logger = new common_1.Logger(DesignSystemSkill_1.name);
...
You MUST respond with ONLY a JSON object in this EXACT structure (no other text):
{
  ...
  "spacing": {
    ...
    "large": "string"
        ...
        const validatedData = this.validator.validate(parsed, skill_outputs_schema_1.DesignSystemSchema);
...
exports.DesignSystemSkill = DesignSystemSkill;
exports.DesignSystemSkill = DesignSystemSkill = DesignSystemSkill_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [ai_gateway_service_1.AIGatewayService,
        output_validator_service_1.OutputValidatorService])
], DesignSystemSkill);
//# sourceMappingURL=design-system.skill.js.map