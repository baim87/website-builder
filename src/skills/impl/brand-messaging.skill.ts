...
import { buildBrandMessagingPrompt } from '../prompts/builders/brand-messaging.prompt';
...
export class BrandMessagingSkill implements Skill {
  ...
  async execute(input: SkillInput): Promise<SkillOutput> {
    ...
    const prompt = buildBrandMessagingPrompt(businessContext, brandStrategy, brandPositioning);
