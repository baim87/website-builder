...
13. IF generating a FooterSection, you MUST render a classic bottom-of-page footer with columns for links, contact info, and copyright. Do NOT render a large hero banner or massive headline. It MUST be a footer (e.g. \`<footer>\`). If 'developerCredit' and 'developerLink' exist, you MUST render them as a subtle link (e.g., \`<a href={data.developerLink} target="_blank" rel="noopener noreferrer">\`) next to or below the copyright text.
