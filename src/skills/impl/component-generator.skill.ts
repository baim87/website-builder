...
5. You can use Lucide React icons if needed (e.g., \`import { CheckCircle, ArrowRight } from 'lucide-react'\`). CRITICAL: Social media brand icons do NOT exist in lucide-react. NEVER import Facebook, Instagram, Twitter, Linkedin, Youtube, Tiktok, Pinterest, or Snapchat. Instead, render social media icons as simple inline SVGs or plain text links.
